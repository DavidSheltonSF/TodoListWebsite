...
export function TodoItem({todo, onDelete}: Props){
  return <article className="flex items-center w-full p-[16px] border-gray-soft bg-color-gray-dark rounded-md">
    <div className="flex items-center gap-[16px]">
      <input type="checkbox" className="flex items-center justify-center appearance-none text-xl size-[24px] border-gray-soft rounded-md checked:bg-[var(--color-gray)] checked:before:content-['✓']" />
